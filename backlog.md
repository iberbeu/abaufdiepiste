...
| FEAT-16 | UX / Notifications | **Round event popups.** Show a modal/toast at key moments: (1) when the lunch break window opens (11:00), (2) when the lunch break window closes (12:30), (3) when only 3 rounds remain, advising players to head back to the Talstation. For this one, include the list of players with the Talstation they selected at the beginning. If they did not select any, still show the name of the player and a "unknown" or something to show that it was not introduced. | — | ~1k |
| FEAT-17 | UX / Animations | **Level-up celebration animation.** When a player's level increases (Anfänger → Fortgeschritten → Profi), show a brief celebration — animated GIF, confetti, or CSS animation. | — | ~2k |
| FEAT-18 | Punkte / Punkteverlauf | **Show current round in Punkteverlauf even if incomplete.** For the current round, display all players: those who have already played show their actual score delta; those who have not yet played show a placeholder ("noch nicht gespielt" or similar). | — | ~1k |
